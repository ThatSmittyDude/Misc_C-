...
using namespace std;
 ...
 const char* tab = "	";
 const char* getPounds = 	"Enter pounds:	";
 const char* getKilograms = 	"Enter kilograms:	";
 const char* getOunces = 	"Enter ounces:	";
 const char* getGrams = 	"Enter grams:	";

 const char* pounds_result = "Pounds:	";
 const char* kilograms_result = "Kilograms:	";
 const char* ounces_result = "Ounces:	";
 const char* grams_result = "Grams:	";

 const char* getOp0 = "Choose given unit:\n";
 const char* getOp1 = "1.	Pounds\n";
 const char* getOp2 = "2.	Kilograms\n";
 const char* getOp3 = "3.	Ounces\n";
 const char* getOp4 = "4.	Grams\n";
 const char* getOp5 = "Choose (1-4):	";
